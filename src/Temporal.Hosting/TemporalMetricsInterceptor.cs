...
/// <summary>
/// Client interceptor that records workflow-start counts and durations to a
/// <see cref="System.Diagnostics.Metrics.Meter"/>, giving a minimal metrics
/// passthrough for the starter.
/// </summary>
public sealed class TemporalMetricsInterceptor : IClientInterceptor
{
    private readonly Counter<long> workflowStartCount;
    private readonly Histogram<double> workflowStartDuration;

    public TemporalMetricsInterceptor(Meter meter)
    {
